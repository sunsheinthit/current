...
export default async function FounderLayout({
  ...
  if ((userData as any)?.role !== 'founder') {
    redirect('/unauthorized')
  }

  const navLinks = [
    { href: '/founder/dashboard', label: 'Dashboard' },
    { href: '/founder/talent', label: 'Browse Talent' },
    { href: '/founder/shortlist', label: 'Shortlist' },
    { href: '/founder/intro-requests', label: 'Intro Requests' },
  ]
